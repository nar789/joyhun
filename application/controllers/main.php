...
class Main extends MY_Controller {
	...
	function push_test(){
		gcm_send("test", "테스트", "테스트입니다.", "ecnVmcN9FGo:APA91bHxX6GhLhN-iYn5Dh_Sd3N4HnxSkqvu7Crf0V2Lc4G7Ip6rAfNRpvgq8Q3Sb3SWGeL7buiwEac24ju1MesDG-v83budfmZLs-f5UcdFj19FpGVAdrp9tKE-Tiz3ryzfGAqgs9IC")	;
	}
	...
	function main_view(){
		...
		if(IS_LOGIN and $this->session->userdata('regi_ok') == "y"){
			...
			get_coordination_member($this->session->userdata['m_userid']);		//회원가입시 선택한 지역에 따른 맵 좌표 생성
	...
	function register_ok_popup(){
		...
		if(strpos($member_data['my_intro'], '[지역]') !== false){
			...
			if($member_data['m_conregion2'] == ""){$member_data['m_conregion2'] = "서울";}
