...
class Main extends MY_Controller {
	...
	function __construct()
	{
		...
		if($_SERVER['REMOTE_ADDR'] == "115.23.169.232" or $_SERVER['REMOTE_ADDR'] == "124.61.213.129" or $_SERVER['REMOTE_ADDR'] == "182.222.244.39" or $_SERVER['REMOTE_ADDR'] == "115.23.189.60" or $_SERVER['REMOTE_ADDR'] == "14.33.56.55"  or  $_SERVER['REMOTE_ADDR'] == "221.163.176.88" or substr($_SERVER['REMOTE_ADDR'],0,11) == "118.34.164." or substr($_SERVER['REMOTE_ADDR'],0,10) == "222.99.24." or substr($_SERVER['REMOTE_ADDR'],0,10) == "14.33.132." or substr($_SERVER['REMOTE_ADDR'],0,9) == "14.33.56." or substr($_SERVER['REMOTE_ADDR'],0,12) == "211.221.215." or substr($_SERVER['REMOTE_ADDR'],0,11) == "175.195.95." or substr($_SERVER['REMOTE_ADDR'],0,8) == "59.12.2."  or substr($_SERVER['REMOTE_ADDR'],0,11) == "118.34.158." or substr($_SERVER['REMOTE_ADDR'],0,12) == "210.100.160."  or substr($_SERVER['REMOTE_ADDR'],0,11) == "221.163.75."  or substr($_SERVER['REMOTE_ADDR'],0,11) == "210.99.164." ){}else{exit;} //사무실만 보이기
