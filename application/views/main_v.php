...
<div class="content">
	...
	<div class="left_main">
		...
		<!--div id="event_popup">
			<div id="close"><img src="<?=IMG_DIR?>/main_evt_ic.gif"></div>
			<a href="/service_center/event/vacance">
				<div class="event_date_btn_1">바로가기
					<div class="event_date_btn_ic color_fff"> > </div>
				</div>
			</a>
		</div-->
				...
				<div class="live_on_menu_area_second" id="tab_menu_01" style="display:block;">
					<div class="margin_left_30">
						...
						<ul class="live_on_menu">
							...
							<li><img src="<?=IMG_DIR?>/live_chat_bar.gif" class="margin_top_11 ver_top"></li>
							<li><b class="uline color_8054f0 pointer" onclick="javascript:magazine_sub_tab('카&재테크');">연애&소개팅</b></li>
						</ul>
					</div>
			...
			<div class="content_03_frame">
				...
				<? 
					...
					if(!$main_manager = $this->cache->get('main_manager')){
						...
						// 매니저의 추천 회원
						$main_manager =  $this->open_marry_m->result_array('T_CoupleMarry_OpenguhonMan', array('b_manager' => '1'), '', '', '3' );
				...
				<div class="con_06_ev_box">
					...
					<?
						if(!$main_event = $this->cache->get('main_event')){
							// 이벤트 배너
							$main_event =  board_list('2', 'reg_event_list', '*', 'm_idx','(m_gubn = "P" or m_gubn = "A") and m_use_yn = "Y" and m_last_day >= sysdate() ');
