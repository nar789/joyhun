		...
		<div class="marriage_top_area">
			<div class="marriage_top_padding">
				<div class="marriage_top_title">
					<div class="float_left">
						<p class="color_fff blod font-size_14 margin_top_13">평생 함께할 인연을 만나 좋은 만남 되세요~</p>
					</div>
					...
					<div class="marriage_box_border">
						<div class="marriage_box_padding">
							<div>
								<div class="select_box_border width_102 height_36">
									<select class="width_102 height_36" id="marry_type" name="marry_type">
										<option value="결혼" <? if($marry_type == "결혼"){ ?> selected <?}?> >결혼</option><!-- value값 바뀌면 해당페이지로 이동 script -->
							...
							<div class="float_right padding_top_7">
								<input type="button" class="blod text_btn2_104293 width_87 height_36" value="회원검색하기" onclick="javascript:search_list();"/>
							</div>
							<div class="clear"></div>
						</div>
					</div>
