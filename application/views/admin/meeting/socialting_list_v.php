<script type="text/javascript">
	...
	$(document).ready(function(){
		$("#search_btn").click(function(){
			...
			if($("#q").val() == ''){
				...
				var act = '/admin/meeting/socialting/social_list';
				if($("#q").val() && sfl_val){
	...
	// 일반삭제
	function socialting_del(m_idx, m_userid){
		...
		if(confirm("삭제하시겠습니까?") == true){
			...
			$.ajax({
				...
				type : "post",
				url : "/admin/meeting/socialting/social_del",
				data : {
					"m_idx"			: m_idx,
					"m_userid"		: m_userid
				},
...
<section id="middle">
	...
	<div id="content" class="padding-20">
		...
		<div id="panel-2" class="panel panel-default">
			<div class="panel-heading">
				<span class="title elipsis">
					<strong>소셜팅리스트</strong> <!-- panel title -->
				</span>
				...
				<div class="table-responsive margin-top-10">
					<table class="table table-bordered table-vertical-middle nomargin">
						...
						<tr>
							...
							<th><nobr>소개글</nobr></th>
							<th class="width-300"><nobr>소셜아이디</nobr></th>
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center"><nobr><?php echo $data['m_userid']?></nobr></td>
								<td class="text-center"><nobr><?php echo $data['m_name']?></nobr></td>
								<td class="text-center"><nobr><?php echo $data['m_nick']?></nobr></td>
								<td class="text-center"><nobr><?php echo $data['m_conregion']?></nobr></td>
								<td><?php echo $data['m_content']?></td>
								<td class="text-center"><nobr>
									<div class="meet_social_ic_bg">
										<a href="#" data-toggle="tooltip" data-placement="top" title="<?=@$data['m_kakao']?>"><img src="<?=IMG_DIR?>/meeting/social_kakao<?if($data['m_kakao'] <> "") echo "_on";?>.png"></a>
										<a href="#" data-toggle="tooltip" data-placement="top" title="<?=@$data['m_nateon']?>"><img src="<?=IMG_DIR?>/meeting/social_nate<?if($data['m_nateon'] <> "") echo "_on";?>.png"></a>
										<a href="#" data-toggle="tooltip" data-placement="top" title="<?=@$data['m_cyworld']?>"><img src="<?=IMG_DIR?>/meeting/social_cyworld<?if($data['m_cyworld'] <> "") echo "_on";?>.png"></a>
										<a href="#" data-toggle="tooltip" data-placement="top" title="<?=@$data['m_facebook']?>"><img src="<?=IMG_DIR?>/meeting/social_facebook<?if($data['m_facebook'] <> "") echo "_on";?>.png"></a>
										<a href="#" data-toggle="tooltip" data-placement="top" title="<?=@$data['m_twitter']?>"><img src="<?=IMG_DIR?>/meeting/social_twitter<?if($data['m_twitter'] <> "") echo "_on";?>.png"></a>
										<a href="#" data-toggle="tooltip" data-placement="top" title="<?=@$data['m_me2day']?>"><img src="<?=IMG_DIR?>/meeting/social_me2day<?if($data['m_me2day'] <> "") echo "_on";?>.png"></a>
									</div></nobr>
								</td>
								<td class="text-center"><nobr><a href="javascript:socialting_del('<?=@$data['m_idx']?>', '<?=@$data['m_userid']?>');" class="btn btn-default btn-xs"><i class="fa fa-times white"></i> Delete </a></nobr></td>
							</tr>
							<?
								}
							}else{
