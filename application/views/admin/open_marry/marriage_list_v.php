	...
	$(document).ready(function(){
		$("#search_btn").click(function(){
			...
			if($("#q").val() == ''){
				...
				var act = '/admin/open_marry/marriage/marriage_list';
				if($("#q").val() && sfl_val){
	...
	function del_list(m_idx, m_userid){
		...
		if(confirm("삭제하시겠습니까?") == true){
			...
			$.ajax({
				...
				type : "post",
				url : "/admin/open_marry/marriage/marriage_list_del/m_idx/"+m_idx+"/m_userid/"+m_userid,
				cache : false,
				async : false,
		...
		if(chk_cnt == 0){
			...
			for(i=0; i<cnt_arr; i++){
				...
				$.ajax({
					...
					type : "post",
					url : "/admin/open_marry/marriage/marriage_list_del/m_idx/"+retu_arr[0]+"/m_userid/"+retu_arr[1],
					cache : false,
					async : false,
					success : function(result){},
					error : function(result){
...
<section id="middle">
	...
	<div id="content" class="padding-20">
		...
		<div id="panel-2" class="panel panel-default">
			<div class="panel-heading">
				<span class="title elipsis">
					<strong>결혼신청 리스트</strong> <!-- panel title -->
				</span>
