<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#btn_write").click(function(){
			location.href = "/admin/service_center/event_mb/event_mb_write";
		});
	...
	function event_search(){
		...
		f.target = "";
		f.action = "/admin/service_center/event_mb/event_list";
		f.submit();
	}
	...
	function event_url_load(m_idx){
		...
		location.href = "/admin/service_center/event_mb/event_mb_write/m_idx/"+m_idx;
	...
	function del_mb_event(m_idx){
		...
		if(confirm("삭제하시겠습니까?") == true){
			...
			$.ajax({
				...
				type : "post",
				url : "/admin/service_center/event_mb/del_mb_event",
				data : {
		...
		<div id="panel-1" class="panel panel-default">			
			<div class="panel-heading">
				<span class="title elipsis">
					<strong>당첨자발표</strong> <!-- panel title -->
				</span>
			...
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table table-bordered table-vertical-middle nomargin">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center"><nobr><a href="javascript:del_mb_event('<?=$data['m_idx']?>');" class="btn btn-default btn-xs"><i class="fa fa-times white"></i> Delete </a></nobr></td>	
							</tr>
							<?
								}
							}else{
					...
					<div class="padding-top-20">
						<div class="col-md-2"><strong>Total :</strong><span class="text-danger">&nbsp; <?=number_format(@$getTotalData2)?> &nbsp;</span>건</div>
						<div class="col-md-8 text-center"><?=@$pagination_links2?></div>
