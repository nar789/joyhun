...
$(document).ready(function(){
	$("#search_btn").click(function(){
		...
		if($("#q").val() == ''){
			...
			var act = '/admin/service_center/notice/notice_list';
			if($("#q").val() && sfl_val){
...
function del_list(idx){
	if(confirm("정말 삭제하시겠습니까?")){
		$.ajax({
				type : "post",
				url : "/admin/service_center/notice/notice_del/idx/"+idx,
				cache : false,
				async : false,
		...
		<div id="panel-1" class="panel panel-default">			
			<div class="panel-heading">
				<span class="title elipsis">
					<strong>공지사항 검색</strong> <!-- panel title -->
				</span>
			...
			<div class="panel-body">
				...
				<form name="fsearch" id="fsearch" method="post" class="form-inline" >
					<div class="form-group col-md-10 col-sm-12 form-inline">
						...
						<?php
						$sfl_arr = array('notice_list.n_title'=>'제목',  'notice_list.n_content'=>'내용', 'notice_list.userid'=>'아이디');
					...
					<table class="table table-bordered table-vertical-middle nomargin">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center"><nobr><?=$data['sel1']?></nobr></td>
								<td class="text-center"><nobr><a href="/admin/service_center/notice/notice_view/page/<?=$page?>/idx/<?=$data['idx']?>"><?=$data['n_title']?></a></nobr></td>
								<td class="text-center"><nobr><?=$data['n_date']?></nobr></td>
								<td class="text-center"><nobr><?=$data['hit']?></nobr></td>
							</tr>
