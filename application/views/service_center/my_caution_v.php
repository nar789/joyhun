<div class="content">
	...
	<div class="left_main width_760">
		...
		<div class="margin_top_32 margin_bottom_10">
			<span class="font-size_16 color_333">나의 처벌내용을 확인할 수 있습니다.</span>
			<div class="police_btn_01 pointer" onclick="complain_request('<?=$user['m_userid']?>','460')">신고하기</div>
		</div>
		<div class="clear"></div>

		<ul class="police_table_2">
			<li class="width_120">사건번호</li>
			<li class="width_120">처벌일</li>
			<li class="width_229">처벌내용</li><!-- 
			<li class="width_144 text-right">처벌해제일</li>
			<li	class="width_110 text-right">처벌결과</li> -->
			<li class="width_144 text-center">처벌해제일</li>
			<li	class="width_110 text-center">처벌결과</li>
		</ul>
		<?php
		...
		<div class="height_40 border_bottom_1_ececec">
			<div class="width_120 block color_999 line-height_40 text-center"><?=$number?></div>
			<div class="width_120 block color_999 line-height_40 text-center"><?=trim_text($data['p_date'],10,'')?></div>
			<div class="width_229 block color_999 line-height_40 text-center"><?=$data['p_content']?></div><!-- 
			<div class="width_150 block color_999 line-height_40 text-right"><?=trim_text($data['p_cancel'],10,'')?></div>
			<div class="width_95 block color_999 line-height_40 text-right"><?=police_card($data['p_card'])?></div> -->
			<div class="width_150 block color_999 line-height_40 text-center"><?=trim_text($data['p_cancel'],10,'')?></div>
			<div class="width_108 block color_999 line-height_40 text-center"><?=police_card($data['p_card'])?></div>
		</div>
		<? }
		}else{?>
