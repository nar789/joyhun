	...
	<div class="left_main">
		...
		<div class="main_top_title">
			<div class="block ver_top">
				<div class="block margin_left_15 margin_top_10">
					<a href="javascript:rank_info();"><img src="<?=IMG_DIR?>/profile/main_top_vvip.png" border="0"></a>
				</div>
			</div>
			<p class="blod color_fff padding_top_12 margin_left_5 font-size_14 block "><?=$pic_title?></p>
			<?if(!$my_profile){?>
			...
			<div class="padding_top_20 padding_left_20">
				...
				<?}else{?>
					<div class="block ver_bottom margin_left_6">
						...
						<div class="icon_btn_bababa margin_left_1"" onclick="<?user_check("chat_request('$recv_id');");?>"><span class="img_talk_btn"></span></div>
		...
		<div class="margin_top_8">
			<div class="confirm_member float_left margin_right_8">
				...
				<div class="confirm_member_box pointer" onclick="view_profile('<?=$val['m_userid']?>');">
					...
					<div class="confirm_member_nick">
						<img src="<?=IMG_DIR?>/profile/main_ic_vvip.png"><img src="<?=IMG_DIR?>/profile/main_top_vvip.png" border="0">
						<b><?=$val['m_nick']?></b>
					</div>
			...
			<div class="confirm_member float_left">
				...
				<div class="confirm_member_box pointer" onclick="view_profile('<?=$val['m_userid']?>');">
					<?=$this->member_lib->member_thumb($val['m_userid'],130,99)?>
					<div class="confirm_member_nick">
						<img src="<?=IMG_DIR?>/profile/main_ic_vip.png">
						<b><?=$val['m_nick']?></b>
					</div>
					<p><?=$val['m_conregion']?> / <?=$this->member_lib->s_symbol($val['m_sex'])?></span><?=$val['m_age']?>세</p>
				</div>
