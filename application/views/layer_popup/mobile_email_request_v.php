...
<div class="padding_10">
	...
	<div class="dor_mb_top" style="padding-top:15px;padding-bottom:15px;">
		<p class="color_333 line-height_18">가입하신 이메일 <b class="color_ea3c3c font-size_14"><?=$email_id?><?=$email_hidden?>@<?=$email_sub?></b>으로 인증메일을 보내드립니다.</p>
	</div>
	...
	<div id="dor_mail_show">
		<div class="dor_mb_bottom height_50 padding_top_15">
			<span class="color_666">인증메일을 확인해주세요.</span><br><span class="color_999">(환경에따라 도착시까지 5분정도 소요될 수 있습니다.)</span>
		</div>
	</div>
