...
<div class="fulltv_con_1">
	...
	<div class="box_2">
		...
		성인 인터넷 방송국 풀티비로<br>
		가입과 동시에 입장됩니다.<br><br>
		<b>풀티비의 모든 기본 서비스는 무료입니다!!</b>
	</div>
	<div class="box_3">
		<div onclick="javascript:btn_fulltv('agree');">
			동 의
		</div>
		<div onclick="javascript:btn_fulltv('cancel');">
			취 소
		</div>
	</div>
</div>
...
<div class="fulltv_con_2">
	...
	<div class="box_2">
		<div onclick="javascript:btn_fulltv('login');">
			풀티비 로그인
		</div>
	</div>
</div>
