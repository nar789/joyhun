			...
			<div class="bg_f4f4f4 height_156">
				<div class="padding_top_20 padding_left_20">
					<div class="popup_img_L ver_top" style="border:0;">
						<? if(@$marry_data['m_userid']){
								echo $this->member_lib->member_thumb($marry_data['m_userid'], 121, 122);
							}else{
					...
					<div class="block width_290 padding_left_6 padding_top_0">
						<input type="text" placeholder="제목" class="color_999 width_435 height_24 margin_left_0 padding_left_9" id="m_title" name="m_title" value="<?=@$marry_data['m_title']?>" <?=@$marry_data['read_only']?> />
						<textarea class="marriage_textarea" placeholder="나를 소개하세요." id="m_content" name="m_content" <?=@$marry_data['read_only']?> ><?=@$marry_data['m_content']?></textarea>
					</div>
				</div>
			</div>
				...
				<table class="popup_border_table">
						...
						<td>
							<div class="popup_select margin_right_2 block width_165 height_24">
								<select class="padding_left_2 width_165 height_24" id="m_incom" name="m_incom">
									...
									<option value="1" <?if(@$marry_data['m_incom'] == "1"){?> selected <?}?> >고졸이하</option>
									<option value="2" <?if(@$marry_data['m_incom'] == "2"){?> selected <?}?> >고졸</option>
									<option value="3" <?if(@$marry_data['m_incom'] == "3"){?> selected <?}?> >전문대졸</option>
									<option value="4" <?if(@$marry_data['m_incom'] == "4"){?> selected <?}?> >대졸</option>
									<option value="5" <?if(@$marry_data['m_incom'] == "5"){?> selected <?}?> >대학원졸</option>
									<option value="6" <?if(@$marry_data['m_incom'] == "6"){?> selected <?}?> >박사과정</option>
									<option value="7" <?if(@$marry_data['m_incom'] == "7"){?> selected <?}?> >유학중</option>
									<option value="8" <?if(@$marry_data['m_incom'] == "8"){?> selected <?}?> >기타</option>
								</select>
							</div>
						</td>
						<td>직업</td>
						<td>
							<div class="popup_select margin_right_2 block width_165 height_24">
								<select class="padding_left_2 width_165 height_24" id="m_job" name="m_job">
									<option value="" >선택하세요.</option>
									<option value="학생" <?if(@$marry_data['m_job'] == "학생"){?> selected <?}?> >학생</option>
									<option value="컴퓨터/인터넷" <?if(@$marry_data['m_job'] == "컴퓨터/인터넷"){?> selected <?}?> >컴퓨터/인터넷</option>
									<option value="언론" <?if(@$marry_data['m_job'] == "언론"){?> selected <?}?> >언론</option>
									<option value="공무원" <?if(@$marry_data['m_job'] == "공무원"){?> selected <?}?> >공무원</option>
									<option value="군인" <?if(@$marry_data['m_job'] == "군인"){?> selected <?}?> >군인</option>
									<option value="서비스업" <?if(@$marry_data['m_job'] == "서비스업"){?> selected <?}?> >서비스업</option>
									<option value="교육" <?if(@$marry_data['m_job'] == "교육"){?> selected <?}?> >교육</option>
									<option value="금융/증권/보험업" <?if(@$marry_data['m_job'] == "금융/증권/보험업"){?> selected <?}?> >금융/증권/보험업</option>
									<option value="유통업" <?if(@$marry_data['m_job'] == "유통업"){?> selected <?}?> >유통업</option>
									<option value="예술" <?if(@$marry_data['m_job'] == "예술"){?> selected <?}?> >예술</option>
									<option value="의료" <?if(@$marry_data['m_job'] == "의료"){?> selected <?}?> >의료</option>
									<option value="법률" <?if(@$marry_data['m_job'] == "법률"){?> selected <?}?> >법률</option>
									<option value="건설업" <?if(@$marry_data['m_job'] == "건설업"){?> selected <?}?> >건설업</option>
									<option value="제조업" <?if(@$marry_data['m_job'] == "제조업"){?> selected <?}?> >제조업</option>
									<option value="부동산업" <?if(@$marry_data['m_job'] == "부동산업"){?> selected <?}?> >부동산업</option>
									<option value="운송업" <?if(@$marry_data['m_job'] == "운송업"){?> selected <?}?> >운송업</option>
									<option value="농/수/임/광산업" <?if(@$marry_data['m_job'] == "농/수/임/광산업"){?> selected <?}?> >농/수/임/광산업</option>
									<option value="자영업" <?if(@$marry_data['m_job'] == "자영업"){?> selected <?}?> >자영업</option>
									<option value="가사(주부)" <?if(@$marry_data['m_job'] == "가사(주부)"){?> selected <?}?> >가사(주부)</option>
									<option value="무직" <?if(@$marry_data['m_job'] == "무직"){?> selected <?}?> >무직</option>
									<option value="기타" <?if(@$marry_data['m_job'] == "기타"){?> selected <?}?> >기타</option>
								</select>
							</div>
						</td>
					</tr>
						...
						<td>
							<div class="popup_select margin_right_2 block width_165 height_24">
								<select class="padding_left_2 width_165 height_24" id="m_attainment" name="m_attainment">
									<option value="" >선택하세요.</option>
									<option value="1" <? if(@$marry_data['m_attainment'] == "1"){ ?> selected <?}?> >1000이하</option>
									<option value="2" <? if(@$marry_data['m_attainment'] == "2"){ ?> selected <?}?> >1000~1500</option>
									<option value="3" <? if(@$marry_data['m_attainment'] == "3"){ ?> selected <?}?> >1500~2000</option>
									<option value="4" <? if(@$marry_data['m_attainment'] == "4"){ ?> selected <?}?> >2000~2500</option>
									<option value="5" <? if(@$marry_data['m_attainment'] == "5"){ ?> selected <?}?> >2500~3000</option>
									<option value="6" <? if(@$marry_data['m_attainment'] == "6"){ ?> selected <?}?> >3000~5000</option>
									<option value="7" <? if(@$marry_data['m_attainment'] == "7"){ ?> selected <?}?> >5000~7000</option>
									<option value="8" <? if(@$marry_data['m_attainment'] == "8"){ ?> selected <?}?> >7000~1억</option>
									<option value="9" <? if(@$marry_data['m_attainment'] == "9"){ ?> selected <?}?> >1억이상</option>
								</select>
							</div>
						</td>
					</tr>
						...
						<td>
							<div class="popup_select margin_right_2 block width_165 height_24">
								<select class="padding_left_2 width_165 height_24" id="m_car" name="m_car">
									<option value="" >선택하세요.</option>
									<option value="1" <? if(@$marry_data['m_car'] == "1"){ ?> selected <?}?> >무소유</option>
									<option value="2" <? if(@$marry_data['m_car'] == "2"){ ?> selected <?}?> >1000CC~1500CC</option>
									<option value="3" <? if(@$marry_data['m_car'] == "3"){ ?> selected <?}?> >1500CC~2000CC</option>
									<option value="4" <? if(@$marry_data['m_car'] == "4"){ ?> selected <?}?> >2000CC~2500CC</option>
									<option value="5" <? if(@$marry_data['m_car'] == "5"){ ?> selected <?}?> >2500CC~3000CC</option>
									<option value="6" <? if(@$marry_data['m_car'] == "6"){ ?> selected <?}?> >3000CC이상</option>
								</select>
							</div>
						</td>
						<td>종교</td>
						<td>
							<div class="popup_select margin_right_2 block width_165 height_24">
								<select class="padding_left_2 width_165 height_24" id="m_faith" name="m_faith">
									<option value="" >선택하세요</option>
									<option value="1" <? if(@$marry_data['m_faith'] == "1"){ ?> selected <?}?> >기독교</option>
									<option value="2" <? if(@$marry_data['m_faith'] == "2"){ ?> selected <?}?> >불교</option>
									<option value="3" <? if(@$marry_data['m_faith'] == "3"){ ?> selected <?}?> >천주교</option>
									<option value="4" <? if(@$marry_data['m_faith'] == "4"){ ?> selected <?}?> >기타종교</option>
									<option value="5" <? if(@$marry_data['m_faith'] == "5"){ ?> selected <?}?> >무교</option>
								</select>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td style="height:220px" colspan="3" class="ver_top">
							<input type="text" placeholder="직접입력" class="color_666 width_435 height_22 margin_left_0 margin_top_9 padding_right_24" id="m_hobby_text" name="m_hobby_text" value="<?=@$marry_data['m_hobby_text']?>" <?=@$marry_data['read_only']?> />
			...
			<? if($this->session->userdata['m_userid'] == @$marry_data['m_userid'] || @$marry_data['m_userid'] == ""){ ?>
			<div class="margin_top_20 text-center padding_bottom_30">
				<input type="button" class="text_btn_de4949 width_62 height_30" value="완료" onclick="javascript:reg_open_marry();"/>	
			</div>
