...
<head>
	...
	<script type="text/javascript" src="https://openapi.map.naver.com/openapi/v2/maps.js?clientId=<?=get_naver_cid('id')?>"></script>
...
<div class="header">
	<?
		...
		//여성회원리워드이벤트 탑 배너 이미지 -> /service_cente/w_e_point_banner.png 입니다. 
		//솔로 이벤트 탑 배너 이미지 -> /m/m_banner_fall.gif
	?>
		...
		<div class="top_box">
			...
			<div class="top_right">
				<ul class="padding_top_8">
					...
					<li class="main_id_style uline"><a href="/profile/my_info"><!-- <a href="/auth/modify/"> -->내정보관리&nbsp;<p> &#9662;</p></a></li>
					<?}else{?>
					<!-- @@ if 비회원 -->
					...
					<!-- <li class="main_id_style"><a href="#">IDIDIDID&nbsp;<p> &#9662;</p></a></li> -->
	...
	<div class="mid_logo">
		<a href="/"><div class="main_left_rogo"></div></a>
		<div class="float_right">
			<!-- 여성회원 전용 이벤트 오른쪽팝업 -->
			<!--<a href="/service_center/event/w_e_point"><img src="<?=IMG_DIR?>/e_w_gift_right_banner.png"></a>-->
			<div class="logo_area">
				<?
					//여성회원 전용 이벤트 로고배너
