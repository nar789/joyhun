...
<h2>최근 댓글 (<?php echo date("Y-m-d")?>)</h2>
...
?>
 	<tr class="bg0">
    	<td class="num"><?php echo  $lt['table'] ?></td>
     	<td class="subject"><a href="/<?php echo  $lt['tbn'] ?>/view/<?php echo  $lt['original_no'] ?>/page/1#row_num_<?php echo $lt['no']?>"><?php echo  $bl1 ?><?php echo strcut_utf8(strip_tags($lt['contents']), 70) ?><?php echo  $bl2 ?></a> <?php echo  $new_icon ?><?php echo  $recom_icon ?></td>
		<td class="name" align="center"><span class='guest'><?php echo  $lt['nickname']; ?></span></td>
        <td class="datetime"><?php echo  substr($lt['reg_date'],11) ?></td>
