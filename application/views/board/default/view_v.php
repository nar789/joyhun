...
<thead>
<tr>
	<th scope="row"><a href="javascript:openWindowFrameless('/message/send/<?php echo $views['user_id']?>','m_send',400,500)"><?php echo $views['user_name']?></a></th>
		...
		<tr id="row_2_<?php echo $row['no']?>">
			<td valign=top style="padding-left:10px;">
				<div style="height:28px; line-height:20px;">
					...
					<strong><a href="javascript:openWindowFrameless('/message/send/<?php echo $row['user_id']?>','m_send',400,500)"<span name="row_num_<?php echo $row['no']?>"><?php echo ($row['nickname'])?$row['nickname']:$row['username']?></a></span></strong>
