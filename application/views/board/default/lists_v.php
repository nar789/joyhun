...
?>
 	<tr class="bg0">
		...
		<td class="name" align="center"><span class='guest'><a href="javascript:openWindowFrameless('/message/send/<?php echo $lt['user_id']?>','m_send',400,500)"><?php  echo $lt['user_name']; ?></a></span></td>
