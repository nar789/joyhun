		...
		<?=$call_tabmenu?>
			...
			?>
				...
				<div class="min_height_78 list_area">
					...
					<? 
						//로그인상태 표시(on, off)
						$cnt = call_connect_member($data['m_userid']);

						if($cnt > "0"){ $flg = "on"; }else{ $flg = "off"; }
					?>
					<img src="<?=IMG_DIR?>/chatting/chatting_<?=$flg?>.gif" class="login_on">		<!-- 로그인상태여부 -->
			...
			<div class="list_area border_bottom_1_ececec">
