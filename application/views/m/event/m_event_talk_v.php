		<div class="winter_top_bg_box">	
			<div class="event_talk_top_bg">
				<div class="width_100per posi_rel" style="height:18%; margin-top:73.8%;">
					...
					<textarea class="event_talk_textarea" id="t_context" placeholder="따뜻한 봄바람 따라서 예쁜 꽃길만 걷게 해줄게!"></textarea>
					<div class="winter_position_box_right block">
						<div class="position_ab" onclick="javascript:alert('이벤트가 종료되었습니다.');">
							<?//=user_check('javascript:msg_member();')?>
							<img src="<?=IMG_DIR?>/m/m_event_talk_btn.png" style="width:100%;">
						</div>
					</div>
				</div>
			</div>
		...
		<div class=" posi_rel solo_content_bg">
			...
			<div class="bg_fff width_100per">
				<div class="padding_top_3per padding_bottom_3per width_100per ">
					...
					<div class="float_left"><b>&nbsp; 메세지&nbsp;</b></div>
