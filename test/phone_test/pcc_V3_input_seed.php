...
<body onload="document.reqPCCForm.id.focus();" bgcolor="#FFFFFF" topmargin=0 leftmargin=0 marginheight=0 marginwidth=0>
        <center>
            ...
            <form name="reqPCCForm" method="post" action="http://www.joyhunting.net/test/phone_test/pcc_V3_sample_seed.php">
                <table cellpadding=1 cellspacing=1>
                    <tr>
                        <td align=center>회원사아이디</td>
                        <td align=left><input type="text" name="id" size='41' maxlength ='8' value = "SANJ001"></td>
                    </tr>
                    <tr>
                        <td align=center>서비스번호</td>
                        <td align=left><input type="text" name="srvNo" size='41' maxlength ='6' value="007003"></td>
                    </tr>
                    <tr>
					...
					<tr>
                        ...
                        <td align=left>
                            <select name="certGb" style="width:320">                                
                    ...
                    <tr>
                        ...
                        <td align=left><input type="text" name="retUrl" size="41" value="32http://www.joyhunting.net/test/phone_test/pcc_V3_popup_seed.php"></td>
                    </tr>
                </table>
                <br><br>
