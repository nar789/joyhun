...
$(document).ready(function(){
	...
	$("#more").on("click", function(){
		...
		$.ajax({
			...
			type : "post",
			url : "/service_center/event_winter/talk_list_more",
			data : {
				"page" : page,
				"rp"   : rp
			},
...
function msg_member(){
	...
	if(confirm("안부를 보내시겠습니까?") == true){
		...
		$.ajax({
			...
			type : "post",
			url : "/service_center/event_winter/reg_talk",
			data : {
...
function comment_view(t_idx, v_userid){
	...
	if($("#talk_comment_"+t_idx).css("display") == "none"){
		...
		$.ajax({
			...
			type : "post",
			url : "/service_center/event_winter/comment_view",
			data : {
...
function reg_reply(t_idx){
	...
	$.ajax({
		...
		type : "post",
		url : "/service_center/event_winter/reg_reply",
		data : {
			"t_idx"				: t_idx,
...
function del_reply(r_idx, t_idx){
	...
	if(confirm("삭제하시겠습니까?") == true){
		...
		$.ajax({
			...
			type : "post",
			url : "/service_center/event_winter/del_reply",
			data : {
