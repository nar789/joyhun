	...
	var gubn = opener.document.getElementById("tmp").value;		//게시판 구분자
	
	var upload_url = "";		//upload_url

	if(gubn == "event"){
		upload_url = "/admin/service_center/event/event_file_upload";
	}else if(gubn == "magazine"){
		upload_url = "/admin/service_center/joy_magazine/magazine_file_upload";
	}
	 ...
	 */
     function goStartMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    		 welBtnConfirm.attr("src","/images/naver/btn_confirm2.png");
     ...
     function goReadyMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") >= 0 ){
	    	 ...
	    	 welBtnConfirm.attr("src","/images/naver/btn_confirm.png");
    	 }
     }   
    ...
    function addImage(ofile){
		...
		if( !!bExceedLimitTotalSize ){
	        ...
	        aFileList.push('	<a onclick="delImage(\'img'+nImageInfoCnt+'\')"><img class="del_button" src="/images/naver/btn_del.png"  width="14" height="13" alt="첨부 사진 삭제"></a>');
			aFileList.push('	</li> ');   
    ...
    function html5Upload() {	
		...
		sUploadURL= upload_url; 	//upload URL    	
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		...
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href.replace(/\/[^\/]*$/, '').replace('/include/naver', '') + upload_url,	//샘플 URL입니다.
